class Threat {
  ...
  PVector move;
  float shade;
  ArrayList<Threat> friends;
  // timers
  int thinkTimer = 0;
  Threat (float xx, float yy) {
  ...
  void go () {
    ...
    arrive(new PVector(width - 50,height/4));
    pos.add(move);
  }
